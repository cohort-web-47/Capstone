...
export const PostSchema = z.object({
    postId: z.string({required_error: 'Please provide a valid postId or null'}).uuid({message: 'please provide a uuid for postId'}),
    ...
    postDatetime: z.coerce.date({required_error: 'please provide a valid postDatetime or null'}).nullable(),
