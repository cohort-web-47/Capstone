...
export const PetSchema = z.object({
    petId: z.string({required_error:'please provide a valid petId or null'}).uuid({message: 'please provide a valid uuid for petId'}),
    ...
    petImageUrl:z.string().max(256, {message: 'please provide a valid petImageUrl'}).nullable(),
