...
import {PrivateProfile,insertPrivateProfile} from '../profile/profile.model'
...
export async function signupProfileController(request: Request, response: Response): Promise<Response | undefined> {
    try {
        ...
        const validationResult = SignUpValidator.safeParse(request.body)
        ...
        const message = `<h2>Welcome to Talking Pets.</h2>
        <p>In order to start speaking you must confirm your account.</p>
        ...
        await insertPrivateProfile(profile)
